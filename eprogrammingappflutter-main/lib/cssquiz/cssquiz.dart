import 'package:eprogrammingappflutter/cssquiz/QuestionCssController.dart';
import 'package:eprogrammingappflutter/cssquiz/components/body.dart';
import 'package:eprogrammingappflutter/widget/Appcolor.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';
class Cssquiz extends StatelessWidget {
  const Cssquiz({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    QuestionCssController _controller = Get.put(QuestionCssController());
    return Container(
